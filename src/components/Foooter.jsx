  ...
  return (
    <div className='w-full flex gap-5 h-screen bg-zinc-900 p-20'>
        <div className='w-1/2 h-full flex flex-col justify-between'>
            ...
            <h1 className='text-7xl uppercase -mb-7 text-[6vw] font-semibold tracking-tighter   font-sans'>Eye-</h1>
            <br />
            <h1 className='text-7xl uppercase -mb-7 text-[6vw] font-semibold tracking-tighter   font-sans'>Opening</h1>
            </div>
        ...
        <div className='w-1/2'>
        <div className='heading'>
            <h1 className='text-7xl uppercase leading-none text-[6vw] font-semibold tracking-tighter font-sans'>Presentation</h1>
                <div className='dets py-10'>
                    <p className='py-5 text-2xl'> S:</p>
                    <a className='block text-xl font-light underline' href="#">Instagam</a>
                    <a className='block text-xl font-light underline' href="#">Behance</a>
                    <a className='block text-xl font-light underline' href="#">Facebook</a>
                    <a className='block text-xl font-light underline' href="#">Linkedin</a>
                </div>
                <div className='flex gap-80'>
                <div className='dets py-10'>
                    <p className='py-5 text-2xl'>M:</p>
                    <a className='block text-xl font-light underline' href="#">Home</a>
                    <a className='block text-xl font-light underline' href="#">Services</a>
                    <a className='block text-xl font-light underline' href="#">Our work</a>
                    <a className='block text-xl font-light underline' href="#">About us</a>
                    <a className='block text-xl font-light underline' href="#">Insights</a>
                    <a className='block text-xl font-light underline' href="#">Contact us</a>
                </div>
                <div className='dets py-10'>
                    <p className='py-5 text-2xl'>L:</p>
                    ...
                    <a className='block text-xl font-light pt-4 underline' href="#">30 Chukarina St</a>
